...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-brand-black border-t border-white/5 relative overflow-hidden pt-16 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/5">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="#" className="p-2.5 rounded-lg bg-white/5 border border-white/5 text-white/60 hover:text-brand-orange hover:border-brand-orange/30 transition-all duration-300">
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-extrabold uppercase tracking-wider text-white">Marketplace</h4>
          ...
          <div className="lg:col-span-2 space-y-4">
            <h4 className="text-xs font-extrabold uppercase tracking-wider text-white">Categorias</h4>
            <ul className="space-y-2 text-xs text-white/50">
          ...
          {/* Newsletter (4 cols) */}
          <div className="lg:col-span-4 space-y-4">
            <h4 className="text-xs font-extrabold uppercase tracking-wider text-white">Inscrição na Newsletter</h4>
            ...
            <form onSubmit={handleSubscribe} className="relative flex items-center">
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-brand-darkGray/80 border border-white/10 text-xs text-white placeholder-white/30 focus:outline-none focus:border-brand-orange focus:ring-1 focus:ring-brand-orange/30 transition-all duration-300 pr-12"
              />
              <button
                type="submit"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-[10px] text-white/35 font-mono">
