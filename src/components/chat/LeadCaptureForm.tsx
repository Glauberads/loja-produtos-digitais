...
export const LeadCaptureForm: React.FC<LeadCaptureFormProps> = ({ onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-4 space-y-4 bg-brand-black/40 rounded-xl border border-white/5">
      <h3 className="text-sm font-bold text-white mb-2 text-center">Fale com um Especialista</h3>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-3 py-2 bg-brand-darkGray/50 border border-white/10 rounded-lg text-white text-sm focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none transition-all"
